// gen-checksum hashes every file under plugins/arthas/ui/ and writes
// the result to ui_checksum.go. Invoked by `go generate ./plugins/arthas/...`
// and by the Taskfile's `build:plugin:arthas` chain.
//
...
func main() {
	...
	contents := fmt.Sprintf(`// Code generated by plugins/arthas/internal/gen-checksum. DO NOT EDIT.
