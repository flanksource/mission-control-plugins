module github.com/flanksource/mission-control-plugins/kubernetes-logs
...
require (
	...
	github.com/flanksource/commons v1.59.0 // indirect
...
require (
	...
	github.com/flanksource/clicky v1.21.63 // indirect
