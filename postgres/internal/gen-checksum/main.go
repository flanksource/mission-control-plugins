// gen-checksum hashes every file under plugins/postgres/ui/ and writes
// the result to ui_checksum.go. Invoked by `go generate ./plugins/postgres/...`
// and by the Taskfile's `build:plugin:postgres` chain.
//
...
func main() {
	...
	contents := fmt.Sprintf(`// Code generated by plugins/postgres/internal/gen-checksum. DO NOT EDIT.
